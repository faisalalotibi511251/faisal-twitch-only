...
client.on("message", message => {
 ...
 if (message.content === "^^help") {
  ...
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .addField("『RnG BoT System』 『اسم البوت』", true)
      
      .addField("『<@149511215264169984>』", true)
      ...
      .addField("『S』『قريبا سوف نضيف المزيد و المزيد من الاوامر 』『N』", true)
...
'*** انا لست الحوت الازرق كما يدعون ***',
 ...
 if (message.content.startsWith('^^مريم')) {
  ...
  .setTitle("لعبة مريم ..")
  .setColor('RANDOM')
  .setDescription(`${FAISAL[Math.floor(Math.random() * FAISAL.length)]}`)
...
القسم الثآلث | مصمم البوت <@149511215264169984>
...
القسم الثالث مصمم البوت | <@149511215264169984>
...
client.on('ready', () => {
   client.user.setGame(" ^^help | ^^invite By RNG SHOP ");
}); 
...
if (message.content === '^^support') {
      message.author.send(' | https://discord.gg/RhpsRnz | لـ أي استفسار').catch(e => console.log(e.stack));
...
if (message.content === '^^invite') {
      message.author.send(' رابط البوت |  https://discordapp.com/api/oauth2/authorize?client_id=514489575251378221&permissions=8&scope=bot ').catch(e => console.log(e.stack));
